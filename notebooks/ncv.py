...
sys.path.append('.')
from model_code import AE, SparseAE, VariationalAutoencoder, BetaVAE, COAETrainer, FactorVAE
...
def WrapVAE(XTrain, XVal, EncodingDim, h1, h2, h3, beta_kl):
    return VariationalAutoencoder(XTrain, XVal, EncodingDim, h1, h2, h3, beta_kl)
